...
const queryReqFields = (req, res, field_list) => {
    ...
    for (const field of field_list) {
        if(req.query[field] == null || (typeof (req.query[field]) === 'string' && req.query[field].trim() === '') || req.query[field] == 'null'){
...
const bodyReqFields = (req, res, field_list) => {
    let resObj = {};
    for (const field of field_list) {
        if(req.body[field] == null || (typeof (req.body[field]) === 'string' && req.body[field].trim() === '') || req.body[field] == 'null') {
